...
namespace NBShaders2.Editor.FeatureLevel
{
    ...
    internal static class NBShaderFeatureLevelRowCatalog
    {
        public static readonly NBShaderFeatureLevelRow[] Rows =
        {
            ...
            Keyword("_DISSOLVE_RAMP", "_DISSOLVE", "Dissolve Ramp", 2),
            Keyword("_DISSOLVE_RAMP_MAP", "_DISSOLVE_RAMP", "Dissolve Ramp Map", 3),
            ...
            Keyword("_FRESNEL", "feature", "Fresnel", 1),
            Keyword("NB_DEBUG_FRESNEL", "_FRESNEL", "Debug Fresnel", 2),
            Keyword("FRESNEL_CUBEMAP", "_FRESNEL", "Fresnel Cubemap", 2),
            Keyword("FRESNEL_REFLECTIONPROBE", "_FRESNEL", "Fresnel Reflection Probe", 2),
            Keyword("_VERTEX_OFFSET", "feature", "Vertex Offset", 1),
            Keyword("_VERTEX_OFFSET_MASKMAP", "_VERTEX_OFFSET", "Vertex Offset Mask Map", 2),
            Keyword("NB_DEBUG_VERTEX_OFFSET", "_VERTEX_OFFSET", "Debug Vertex Offset", 2),
            Keyword("_CUSTOM_LOCAL_TRANSFORM", "_VERTEX_OFFSET", "Custom Local Transform", 2),
