...
namespace NBShaders2.Editor.FeatureLevel
{
    ...
    internal static class NBShaderFeatureLevelRowCatalog
    {
        public static readonly NBShaderFeatureLevelRow[] Rows =
        {
            ...
            Keyword("_EMISSION", "feature", "Overlay Texture 1", 1, NBShaderFeaturePerformanceCost.Medium, "Blends the first extra color texture."),
            ...
            Keyword("_COLORMAPBLEND", "feature", "Overlay Texture 2", 1, NBShaderFeaturePerformanceCost.Medium, "Blends the second extra color texture."),
