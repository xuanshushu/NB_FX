...
namespace NBShaders2.Editor.FeatureLevel
{
    ...
    internal static class NBShaderFeatureLevelRowCatalog
    {
        public static readonly NBShaderFeatureLevelRow[] Rows =
        {
            ...
            Keyword("_CHROMATIC_ABERRATION", "_NOISEMAP", "Chromatic Aberration", 2, NBShaderFeaturePerformanceCost.High, "Splits color channels for distortion fringe."),
            ...
            Keyword("_DISSOLVE_EDITOR_TEST", "_DISSOLVE", "Editor Dissolve Test", 2, NBShaderFeaturePerformanceCost.Low, "Enables editor preview control for dissolve."),
            ...
            Keyword("FRESNEL_CUBEMAP", "_FRESNEL", "Fresnel Cubemap", 2, NBShaderFeaturePerformanceCost.High, "Samples a cubemap for fresnel color."),
            Keyword("FRESNEL_REFLECTIONPROBE", "_FRESNEL", "Fresnel Reflection Probe", 2, NBShaderFeaturePerformanceCost.High, "Uses reflection probe data for fresnel highlights."),
            ...
            Keyword("_CUSTOM_LOCAL_TRANSFORM", "_VERTEX_OFFSET", "Custom Local Transform", 2, NBShaderFeaturePerformanceCost.Medium, "Applies a custom local transform basis."),
