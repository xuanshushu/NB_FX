...
namespace NBShaderEditor
{
    internal sealed class ColorBlendFeatureItem : FeatureToggleFoldOutItem
    {
        ...
        {
            AddTextureWithWrap(rootItem, this, "_ColorBlendMap", "颜色渐变贴图", W9ParticleShaderFlags.FLAG_BIT_WRAPMODE_COLORBLENDMAP, "_ColorBlendColor");
            new UVModeSelectItem(rootItem, this, "_ColorBlendUVModeFoldOut", W9ParticleShaderFlags.FLAG_BIT_UVMODE_POS_0_COLOR_BLEND_MAP, 0, () => Content("颜色渐变贴图UV来源"), "_ColorBlendMap");
            new CustomDataSelectItem(rootItem, this, W9ParticleShaderFlags.FLAGBIT_POS_3_CUSTOMDATA_COLOR_BLEND_OFFSET_X, 3, () => Content("颜色渐变贴图X轴偏移自定义曲线"));
            new CustomDataSelectItem(rootItem, this, W9ParticleShaderFlags.FLAGBIT_POS_3_CUSTOMDATA_COLOR_BLEND_OFFSET_Y, 3, () => Content("颜色渐变贴图Y轴偏移自定义曲线"));
