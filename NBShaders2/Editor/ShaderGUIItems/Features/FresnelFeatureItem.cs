...
namespace NBShaderEditor
{
    internal sealed class FresnelFeatureItem : FeatureToggleFoldOutItem
    {
        ...
        public FresnelFeatureItem(NBShaderRootItem rootItem, ShaderGUIItem parentItem)
            : base(rootItem, parentItem, "_FresnelBlockFoldOut", "_fresnelEnabled", "菲涅尔", W9ParticleShaderFlags.FLAG_BIT_PARTICLE_FRESNEL_ON)
        {
            ...
            new CustomDataSelectItem(rootItem, this, W9ParticleShaderFlags.FLAGBIT_POS_0_CUSTOMDATA_FRESNEL_OFFSET, 0, () => Content("菲涅尔位置自定义曲线"));
