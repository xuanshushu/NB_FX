...
namespace NBShaderEditor
{
    internal sealed class SharedUVFeatureItem : FeatureToggleFoldOutItem
    {
        ...
        {
            new UVModeSelectItem(rootItem, this, "_SharedUVModeFoldOut", W9ParticleShaderFlags.FLAG_BIT_UVMODE_POS_0_SHAREDUV, 0, () => Content("公共UV来源"), forceEnable: true);
            ...
            new CustomDataSelectItem(rootItem, this, W9ParticleShaderFlags.FLAGBIT_POS_3_CUSTOMDATA_SHARED_UV_OFFSET_X, 3, () => Content("公共UV X轴偏移自定义曲线"));
            new CustomDataSelectItem(rootItem, this, W9ParticleShaderFlags.FLAGBIT_POS_3_CUSTOMDATA_SHARED_UV_OFFSET_Y, 3, () => Content("公共UV Y轴偏移自定义曲线"));
            InitTriggerByChild();
        }
    }
}
