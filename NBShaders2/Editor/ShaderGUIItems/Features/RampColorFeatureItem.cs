...
namespace NBShaderEditor
{
    internal sealed class RampColorFeatureItem : FeatureToggleFoldOutItem
    {
            ...
            : base(rootItem, parentItem, "_RampColorBlockFoldOut", "_RampColorToggle", "颜色映射(Ramp)", keyword: "_COLOR_RAMP")
        {
            ...
            AddTextureWithWrap(rootItem, this, "_RampColorMap", "颜色映射黑白图", W9ParticleShaderFlags.FLAG_BIT_WRAPMODE_RAMP_COLOR_MAP,
            ...
            new WrapModeItem(rootItem, this, W9ParticleShaderFlags.FLAG_BIT_WRAPMODE_RAMP_COLOR_MAP, () => Content("颜色映射UV Wrap"), 2,
                () => IsPropertyMode(rootItem, "_RampColorSourceMode", 0));
            new ColorChannelSelectItem(rootItem, this, W9ParticleShaderFlags.FLAG_BIT_COLOR_CHANNEL_POS_0_RAMP_COLOR_MAP, 0, () => Content("颜色映射黑白图通道选择"),
                () => IsPropertyMode(rootItem, "_RampColorSourceMode", 1));
            new UVModeSelectItem(rootItem, this, "_RampColorUVModeFoldOut", W9ParticleShaderFlags.FLAG_BIT_UVMODE_POS_0_RAMP_COLOR_MAP, 0, () => Content("颜色映射黑白图UV来源"), "_RampColorMap", true);
