...
namespace NBShaderEditor
{
    internal sealed class VertexOffsetFeatureItem : FeatureToggleFoldOutItem
    {
        public VertexOffsetFeatureItem(NBShaderRootItem rootItem, ShaderGUIItem parentItem)
            : base(rootItem, parentItem, "_VertexOffsetBlockFoldOut", "_VertexOffset_Toggle", "顶点偏移", W9ParticleShaderFlags.FLAG_BIT_PARTICLE_VERTEX_OFFSET_ON)
        {
            ...
            AddTextureWithWrap(rootItem, this, "_VertexOffset_Map", "顶点偏移贴图", W9ParticleShaderFlags.FLAG_BIT_WRAPMODE_VERTEXOFFSETMAP);
            new UVModeSelectItem(rootItem, this, "_VertexOffsetUVModeFoldOut", W9ParticleShaderFlags.FLAG_BIT_UVMODE_POS_0_VERTEX_OFFSET_MAP, 0, () => Content("顶点偏移贴图UV来源"), "_VertexOffset_Map");
            new CustomDataSelectItem(rootItem, this, W9ParticleShaderFlags.FLAGBIT_POS_1_CUSTOMDATA_VERTEX_OFFSET_X, 1, () => Content("顶点扰动X轴偏移自定义曲线"));
            new CustomDataSelectItem(rootItem, this, W9ParticleShaderFlags.FLAGBIT_POS_1_CUSTOMDATA_VERTEX_OFFSET_Y, 1, () => Content("顶点扰动Y轴偏移自定义曲线"));
            ...
            new CustomDataSelectItem(rootItem, this, W9ParticleShaderFlags.FLAGBIT_POS_1_CUSTOMDATA_VERTEXOFFSET_INTENSITY, 1, () => Content("顶点扰动强度自定义曲线"));
            new ToggleItem(
                rootItem,
                this,
            ...
            PropertyToggleBlockItem maskBlock = ToggleBlock(rootItem, "_VertexOffsetMaskBlockFoldOut", "_VertexOffset_Mask_Toggle", "顶点偏移遮罩",
                W9ParticleShaderFlags.FLAG_BIT_PARTICLE_1_VERTEXOFFSET_MASKMAP, 1, parent: this);
